...
uint32_t processQwerty(bool lookup) {
    ...
    P( LNO | RNO | LA | RU,     SEND(KC_LGUI); SEND(KC_LSFT));
    P( LNO | LA  | RE,          SEND(KC_LGUI); SEND(KC_LSFT); SEND(KC_LALT));
    ...
    // P( RU,                     SEND(KC_LGUI)); SEND(KC_LCTL); SEND(KC_LSFT); SEND(KC_LALT);
    // P( RNO,                    SEND(KC_LGUI)); SEND(KC_LALT);
